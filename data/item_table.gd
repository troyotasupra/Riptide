...
const ITEMS := {
	...
	"sand": {"name": "Sand", "category": "material", "weight": 2.2, "stack": 10, "hint": "Dug from the beach. Fill a bag with it (B) and stack the bags into a wall."},
	"sandbag": {"name": "Sandbag", "category": "placeable", "weight": 14.0, "stack": 4, "places": "sandbag_wall", "hint": "Heavy. Place one to start a wall, then add more bags to build it up."},
	...
	"oar": {"name": "Oars", "category": "tool", "tool": "oar", "weight": 1.4, "stack": 1, "hint": "A pair of oars. Fit them in a boat's oarlocks (F at the oarlocks); then F aboard takes them up: Q strokes left, E right. Take them with you when you leave, and nobody can row your boat away."},
	...
	"fuel_drum": {"name": "Fuel drum", "category": "part", "weight": 18.0, "stack": 1, "hint": "Twenty litres of outboard fuel in a steel drum. Heavy: a raft carries them far better than you do. At the boat's stern, F pours it into the motor's tank."},
	...
	"compartment_key": {"name": "Small brass key", "category": "key", "weight": 0.02, "stack": 1, "hint": "Opens the locked footlocker in the fishing shack — press F on it."},
